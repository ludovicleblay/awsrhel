...
echo&Launch "$SCP $JENKINS_ARTIFACTS_PATH/$MB_NODE_ZIP $REMOTE_USER@$REMOTE_HOST:$MB_NODE_TEMP_DIR/$MB_NODE_ZIP"
echo&Launch "cd $MB_NODE_TEMP_DIR; unzip -qq $MB_NODE_ZIP -d $MISYSBOARD_NODE_REPO"
